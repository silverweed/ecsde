...
pub fn key_to_char(key: Key, maiusc: bool) -> Option<char> {
    match key {
        ...
        Key::Space => Some(if maiusc { ' ' } else { ' ' }),
        Key::Tab => Some(if maiusc { '\t' } else { '\t' }),
        Key::Add => Some(if maiusc { '+' } else { '+' }),
        Key::Subtract => Some(if maiusc { '-' } else { '-' }),
        Key::Multiply => Some(if maiusc { '*' } else { '*' }),
        Key::Divide => Some(if maiusc { '/' } else { '/' }),
        Key::Numpad0 => Some(if maiusc { '0' } else { '0' }),
        Key::Numpad1 => Some(if maiusc { '1' } else { '1' }),
        Key::Numpad2 => Some(if maiusc { '2' } else { '2' }),
        Key::Numpad3 => Some(if maiusc { '3' } else { '3' }),
        Key::Numpad4 => Some(if maiusc { '4' } else { '4' }),
        Key::Numpad5 => Some(if maiusc { '5' } else { '5' }),
        Key::Numpad6 => Some(if maiusc { '6' } else { '6' }),
        Key::Numpad7 => Some(if maiusc { '7' } else { '7' }),
        Key::Numpad8 => Some(if maiusc { '8' } else { '8' }),
        Key::Numpad9 => Some(if maiusc { '9' } else { '9' }),
        _ => None,
    }
}
