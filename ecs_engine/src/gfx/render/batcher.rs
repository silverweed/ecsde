...
#[derive(Default)]
pub struct Batches {
    textures_ws: HashMap<Texture_Handle, (Vertex_Buffer_Holder, Vec<Texture_Props_Ws>)>,
}
...
pub fn draw_batches(
    ...
    for (tex_id, (vbuffer, tex_props)) in &mut batches.textures_ws {
...

        {
            ...
            let null_vertex =
                render::Vertex::new(v2!(0., 0.), colors::TRANSPARENT.into(), v2!(0., 0.).into());
